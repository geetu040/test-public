...
| **Attribute**     | **Details**                                               |
|:-------------------:|:-----------------------------------------------------------:|
| **Program**       | [Google Summer of Code, 2024](https://summerofcode.withgoogle.com/)                              |
...
| **Project Title** | Sktime integration with deep learning backends - pytorch and huggingface - [Project Dashboard](https://summerofcode.withgoogle.com/programs/2024/projects/f5FggiB7) |
